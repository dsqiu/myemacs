...
(setq exec-path (split-string "/opt/mips-4.3/bin:/home/dsqiu/work/tools/android_sdk/android-sdk-linux_86/tools:/home/dsqiu/work/tools/android_sdk/android-sdk-linux_86/platform-tools:/home/dsqiu/work/tools/eclipse/:/home/dsqiu/bin:/usr/lib/lightdm/lightdm:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games" path-separator))
...
(max-comp 3) )
(if (<= len max-comp)
(if (string-equal path "/home/dsqiu") "~" path)
...
(defun android-build-mode()
  ...
  (interactive)
  (let ((path (concat (android-find-build-tree-root) "prebuilts/gcc/linux-x86/mips/mipsel-linux-android-4.6/bin")))
    (message "%s" path)
